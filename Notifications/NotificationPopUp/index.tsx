...
const NotificationPopUp = () => {
  ...
  const renderNotificationBody = () => {
        ...
        <TouchableOpacity onPress={handleReplyChatNavigation} style={styles.body}>
          <View style={styles.header}>
            ...
            <Text style={styles.headerText}>
              <Text style={styles.username}>{notificationData?.senderUserData?.username}</Text> replied to your chat in{' '}
              <Text style={styles.convoRoom}>{notificationData?.convo.convoStarter}</Text>
            </Text>
          </View>

          <View
            style={{
              backgroundColor: 'rgba(98, 95, 224, 0.2)',
              padding: 5,
              marginTop: 15,
              borderRadius: 5,
              marginHorizontal: 15,
          ...
          >
            <Text style={{ fontFamily: 'bold', color: appearanceMode.textColor }}>
              You: {notificationData?.data?.replyChat?.content}
            </Text>
          </View>
    ...
    if (notificationData?.type === 'keepup') {
      return (
        <TouchableOpacity onPress={handleKeepUpProfileNavigation} style={styles.body}>
          <View style={[styles.header, { justifyContent: 'center', alignItems: 'center' }]}>
            <Image style={styles.userImage} source={require('@/assets/images/blankprofile.png')} />
            <Text style={styles.headerText}>
              <Text style={styles.username}>{notificationData?.senderUserData?.username}</Text> started keeping up with
              your {notificationData.convo?.dialogue ? 'Dialogue' : 'Convo'}:{' '}
              <Text style={styles.convoRoom}>{notificationData.convo?.convoStarter}</Text>
            </Text>
          </View>
        </TouchableOpacity>
    ...
    if (notificationData?.type === 'privatecircle') {
      return (
        <TouchableOpacity onPress={handleKeepUpProfileNavigation} style={styles.body}>
          <Text style={{ fontFamily: 'extrabold', color: appearanceMode.textColor, marginBottom: 10, fontSize: 16 }}>
            Private
          </Text>
          ...
          <View style={[styles.header, { justifyContent: 'center', alignItems: 'center' }]}>
            <Image style={styles.userImage} source={require('@/assets/images/blankprofile.png')} />
            <Text style={styles.headerText}>
              <Text style={styles.username}>{notificationData?.senderUserData?.username}</Text> is requesting to join
              your private circle
            </Text>
          </View>
        </TouchableOpacity>
    ...
    if (notificationData?.type === 'privatecircleacceptance') {
      return (
        <TouchableOpacity onPress={handleKeepUpProfileNavigation} style={styles.body}>
          <View style={[styles.header, { justifyContent: 'center', alignItems: 'center' }]}>
            <Image style={styles.userImage} source={require('@/assets/images/blankprofile.png')} />
            <Text style={styles.headerText}>
              ...
              <Text style={styles.username}>{notificationData?.senderUserData?.username}</Text>'s Private Circle
            </Text>
          </View>
        </TouchableOpacity>
      )
    ...
    if (notificationData?.type === 'userkeepup') {
      return (
        <TouchableOpacity onPress={handleKeepUpProfileNavigation} style={styles.body}>
          <View style={[styles.header, { justifyContent: 'center', alignItems: 'center' }]}>
            <Image style={styles.userImage} source={require('@/assets/images/blankprofile.png')} />
    ...
    if (notificationData?.type === 'invitetoprivatecircle') {
      return (
        <TouchableOpacity onPress={handleKeepUpProfileNavigation} style={styles.body}>
          <View style={[styles.header, { justifyContent: 'center', alignItems: 'center' }]}>
            <Image style={styles.userImage} source={require('@/assets/images/blankprofile.png')} />
            <Text style={styles.headerText}>
              <Text style={styles.username}>{notificationData?.senderUserData?.username}</Text> is inviting you to join
    ...
    if (notificationData?.type === 'invitetoprivatecircleacceptance') {
      return (
        <TouchableOpacity onPress={handleKeepUpProfileNavigation} style={styles.body}>
          <View style={[styles.header, { justifyContent: 'center', alignItems: 'center' }]}>
            <Image style={styles.userImage} source={require('@/assets/images/blankprofile.png')} />
            <Text style={styles.headerText}>
              <Text style={styles.username}>{notificationData?.senderUserData?.username}</Text> accepted your invite
            </Text>
          </View>
        </TouchableOpacity>
      )
    ...
    if (notificationData?.type === 'convoforuserskeepingup') {
      return (
        <TouchableOpacity onPress={handleChatNavigation} style={styles.body}>
          {notificationData?.data?.private && (
            <Text style={{ fontFamily: 'extrabold', color: appearanceMode.textColor, marginBottom: 10, fontSize: 16 }}>
              Private
            </Text>
          )}

          {notificationData.senderUserData && (
            <View style={[styles.header, { justifyContent: 'center', alignItems: 'center' }]}>
              <Image style={styles.userImage} source={require('@/assets/images/blankprofile.png')} />
              <Text style={styles.headerText}>
                <Text style={styles.username}>{notificationData?.senderUserData.username}</Text> started a{' '}
                {notificationData?.data?.dialogue ? 'Dialogue' : 'Convo'}:{' '}
                <Text style={styles.convoRoom}>{notificationData?.data?.convoStarter}</Text>
              </Text>
            </View>
          )}
        </TouchableOpacity>
    ...
    if (notificationData?.type === 'highlights') {
      return (
        <TouchableOpacity onPress={handleHighlight} style={styles.body}>
          ...
          <View style={[styles.header, { justifyContent: 'center', alignItems: 'center' }]}>
            ...
            <Text style={styles.headerText}>
              <Text style={styles.username}>There are new highlights {authenticatedUserData?.username}</Text>
            </Text>
          </View>
        </TouchableOpacity>
      )
    ...
    if (notificationData?.type === 'discover') {
      return (
        <TouchableOpacity onPress={handleDiscover} style={styles.body}>
          <Text style={{ fontFamily: 'extrabold', color: appearanceMode.textColor, marginBottom: 10, fontSize: 16 }}>
            Discover: {notificationData?.title}
          </Text>

          <View style={[styles.header, { justifyContent: 'center', alignItems: 'center' }]}>
            <Image style={styles.userImage} source={require('@/assets/images/logo.png')} />
            <Text style={styles.headerText}>
              <Text style={styles.username}>{notificationData?.caption}</Text>
            </Text>
          </View>
        </TouchableOpacity>
      )
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <GestureDetector gesture={panGesture}>
        <Animated.View style={[animatedNotification]}>{renderNotification()}</Animated.View>
      </GestureDetector>
    </GestureHandlerRootView>
  )
}
