...
const SystemNotification = () => {
  ...
  const animatedNotification = useAnimatedStyle(() => ({
    transform: [{ translateY: notificationDisplay.value }],
  }))
    ...
    if (systemNotificationData?.type === 'error') {
      return (
        <View style={{ justifyContent: 'center', alignItems: 'center', padding: 20 }}>
          <Text style={{ color: '#E33629', fontFamily: 'extrabold', fontSize: 15, textAlign: 'center' }}>
      ...
      return (
        <View style={{ justifyContent: 'center', alignItems: 'center', padding: 20 }}>
          <Text style={{ color: 'green', fontFamily: 'extrabold', fontSize: 15, textAlign: 'center' }}>
            {systemNotificationData?.message}
          </Text>
        </View>
      )
      ...
      return (
        <View style={{ justifyContent: 'center', alignItems: 'center', padding: 20 }}>
          <Text style={{ color: appearanceMode.textColor, fontFamily: 'extrabold', fontSize: 15, textAlign: 'center' }}>
            {systemNotificationData?.message}
          </Text>
        </View>
      )
